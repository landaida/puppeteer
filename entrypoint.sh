...
: ${IMG_DIR:="${HOME}/img"}      # Location of built Meteor app
: ${BRANCH:="master"}
...
#echo "Installing forever js..."
#npm install forever -g
echo "Starting Meteor Application"
exec nodemon ./main.js
#exec node ./main.js
#exec node --version
#exec node ./main.js > /home/meteor/logs.log
#exec forever start -l /home/meteor/forever.log -o /home/meteor/out.log -e /home/meteor/err.log ./main.js
